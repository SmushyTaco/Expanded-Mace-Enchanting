...
tasks {
    ...
    register<TaskPublishCurseForge>("publishCurseForge") {
        ...
        file.displayName = "[${libs.versions.minecraft.get()}] Expanded Mace Enchanting"
...
modrinth {
    ...
    projectId = "expanded-mace-enchanting"
    uploadFile.set(tasks.remapJar)
    gameVersions.add(libs.versions.minecraft)
    versionName = libs.versions.minecraft.map { "[$it] Expanded Mace Enchanting" }
    dependencies {
